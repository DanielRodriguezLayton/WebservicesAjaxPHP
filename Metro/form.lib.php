...
*/        
    ...
    private static function presetTags(){
        ...
        $posOrigenSolicitud = strpos($_SERVER['HTTP_REFERER'], "SoOrigenSolicitud=");
        
        if ($posOrigenSolicitud !== false){
            self::setValue( 'OrigenSolicitud', substr($_SERVER['HTTP_REFERER'], $posOrigenSolicitud + 18));
        }else{
            self::setValue( 'OrigenSolicitud', "" );
        }
...
<?php
    ...
    private static function saveRecord(){
        ...
        if( class_exists('\JF\Form2DB') ){
            ...
            $NuevoRaNumero = $form2db->saveFormData( self::$values );
        }
