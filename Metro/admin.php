...
require_once ("$PathApp/Lib/RecursosRadicarSoliciud.php");
require_once ("$PathApp/WebServices/RegistrarPQRSD/FuncionesRegistrarPQRSD.php");
require_once ("$PathApp/Lib/EnvioMensajeSGP.php");
require_once ("$PathApp/Lib/RecursosIntegracionAZDigital.php");
require_once ("$PathApp/Lib/RecursosEventoPersonalizado.php");

require_once("$PathSGP/Lib/Utilidades.php");
require_once("$PathSGP/Lib/XsltTransform.php");
require_once("$PathSGP/Lib/UtilidadesSQL.php");
require_once("$PathSGP/WebServices/WebServicesLib.php");
require_once ($PathSGP . "/BD/$BaseDatosMotor/ExecSql.php");
require_once ($PathSGP . "/BD/$BaseDatosMotor/FuncionesSQL.php");
require_once ("$PathSGP/Lib/ConsultarInformacionNavegador.php");
...
<?php
   ...
   private static function sendVerificationCode(){
    ...
    private static function validateForm(){
        ...
        $NuevoRaNumero = Form::validate($_POST);
        if( !Form::isValid() ){
            ...
            $result['NuevoRaNumero'] = $NuevoRaNumero;
            self::sendmail();
            self::sendSms();
...
class DataManager
{
    ...
    echo "<p>Eres un bot</p>";
    } else if ($captcha_success->success==true) {
    echo "<p>No eres un bot</p>";
    }
# end of class
